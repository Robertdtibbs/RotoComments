...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.premierleague.com/news").then(function(response) {
    // Load that into cheerio and save it to our selector
    var $ = cheerio.load(response.data);

    // Grab every section with the class of featuredArticle
    $("section.featuredArticle").each(function(i, element) {
      // Save an empty result object
      var result = {};

      // Grab four different specific items on the webpage
      result.title = $(this).find("span.title").text();
      result.body = $(this).find("span.text").text();
